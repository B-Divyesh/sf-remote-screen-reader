...
- Demo screens are synthetic interface fixtures drawn for this product. The shipped WebP files contain only the phrases used by the OCR regression test and no third-party UI.
- The 1200 × 630 social preview is a crop of the original reader-bridge illustration. The 180 px touch icon and Android legacy/round icons are derived from the original app mark.
