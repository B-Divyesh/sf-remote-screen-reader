...
assert(config.routes?.some(route => route.route === '/404' && route.statusCode === 404 && !route.rewrite), 'the public /404 route must return HTTP 404 without an invalid rewrite/status combination');
